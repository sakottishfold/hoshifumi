...
**Atmosphere キーワード**:dim / warm / quiet / spacious / contemplative / cosmic / intimate

**Anti-Atmosphere**(避けるべき):bright / loud / hurried / busy / sharp / cold / clinical / "tech"
...
### Secondary Accent ─ Lavender(補助、控えめ)
...
- Tailwind class なし、文字色 `text-neutral-500` でリンクとして配置
